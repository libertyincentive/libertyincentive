...
const translations = {
  en: {
    ...
    aboutToursIntro: "Liberty Incentive offers a wide variety of journeys throughout Armenia and combined programs with Georgia.",
  ...
  hy: {
    ...
    aboutToursIntro: "Liberty Incentive-ն առաջարկում է բազմազան ճանապարհորդություններ ամբողջ Հայաստանում, ինչպես նաև համակցված ծրագրեր Վրաստանի հետ։",
