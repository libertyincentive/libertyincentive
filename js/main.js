...
const translations = {
  en: {
    ...
    aboutEdgeLabel: "Our Edge",
    aboutEdgeText: "Our strength is the synergy of our destination-management expertise and worldwide partnerships. It enables us to give every client excellent value, dependable organization and genuinely creative solutions.",
    aboutArmeniaTitle: "Representing the true spirit of Armenia",
    aboutArmeniaOne: "As one of Armenia's established incoming tour operators, Liberty Incentive continues to develop in response to changing travel trends and the evolving interests of our clients.",
    aboutArmeniaTwo: "We proudly represent Armenia worldwide—a country of unique culture, ancient history, living customs, unspoiled nature, original architecture and colorful fine arts.",
    aboutArmeniaThree: "Our work focuses on the experiences Armenia can offer through its culture, traditions and exceptional hospitality. Every program also considers the country's location, social stability, climate, professional tourism services and competitive value.",
    aboutGoalsTitle: "We set clear goals",
    aboutGoalOne: "Help travelers feel the Armenian spirit through our peerless nature, cultural heritage and unique hospitality.",
    aboutGoalTwo: "Provide the best possible conditions for travel, discovery and relaxation.",
    aboutGoalThree: "Understand every request and make each holiday comfortable, seamless and unforgettable.",
    aboutToursLabel: "What We Create",
    aboutToursTitle: "One destination. Countless ways to experience it.",
    aboutToursIntro: "Liberty Incentive creates a wide variety of journeys throughout Armenia, combined programs with Georgia, and carefully designed travel experiences in destinations around the world.",
    aboutToursCulture: "Classic, cultural, historical, pilgrimage and religious tours",
    aboutToursMice: "Incentive travel, MICE, conferences, events and corporate programs",
    aboutToursActive: "Hiking, biking, jeep, moto, extreme and adventure tours",
    aboutToursNature: "Geographic, eco, bird-watching, hunting, fishing and photo tours",
    aboutToursLifestyle: "Wine, gastronomic, shopping, medical, winter and boat tours",
    aboutToursClasses: "Master classes in Armenian dance, cuisine, crafts and traditions",
    aboutStayTitle: "Accommodation for every travel style",
    aboutStayText: "We arrange lodging for different budgets and preferences—from international five-star hotels and boutique properties to welcoming family-run accommodations and hostels.",
    aboutTeamTitle: "A multilingual professional team",
    aboutTeamText: "Our service team includes experienced English-, French-, German-, Chinese-, Italian- and Spanish-speaking guide-interpreters, professional hiking and climbing instructors, drivers, cooks and assistants. Many have worked with us for years and are selected not only for their professional skills and language ability, but also for their deep understanding of contemporary Armenia.",
    aboutOptionsTitle: "The best options for every partner",
    aboutOptionOne: "Traditional and creative concepts",
    aboutOptionTwo: "Tailor-made solutions",
    aboutOptionThree: "Attractive program design",
    aboutOptionFour: "Competitive pricing",
    aboutOptionFive: "Flexibility to transform every experience around your needs",
    aboutQuote: "Success is not based on doing extraordinary things, but on doing ordinary things extraordinarily well.",
    aboutClosingTitle: "Join us and enrich your life with new experiences.",
    aboutClosingText: "Liberty Incentive is ready to welcome you with Armenia's distinctive warmth and hospitality.",
    ...
    /* Yerevan destination page */
    yerevanPageTitle: "Discover Yerevan | Liberty Incentive",
    yerevanHeroLabel: "The Pink City",
    yerevanHeroTitle: "Yerevan",
    yerevanHeroText: "Ancient roots, creative energy and warm hospitality in the heart of Armenia.",
    backToArmenia: "← Back to Discover Armenia",
    yerevanIntro: "One of the world's oldest continuously inhabited cities, Yerevan is both deeply historical and unmistakably modern—a relaxed capital shaped by pink volcanic stone, open squares, fountains, art and café culture.",
    yerevanStoryTitle: "A city older than Rome",
    yerevanStoryOne: "Yerevan's story begins with the fortress of Erebuni, founded in 782 BCE by King Argishti I. The archaeological site still overlooks the modern capital and offers a remarkable connection between ancient Urartian history and everyday city life.",
    yerevanStoryTwo: "Today, Yerevan is Armenia's cultural and social center. Its walkable heart brings together Soviet-era urban planning, contemporary architecture, galleries, music, markets and lively public spaces.",
    yerevanFactsFounded: "Founded",
    yerevanFactsFoundedValue: "782 BCE",
    yerevanFactsCharacter: "Known as",
    yerevanFactsCharacterValue: "The Pink City",
    yerevanSightsTitle: "Essential places to experience",
    yerevanSightOneTitle: "Republic Square",
    yerevanSightOneText: "The city's grand central square, surrounded by rose-colored architecture, museums and evening musical fountains.",
    yerevanSightTwoTitle: "The Cascade",
    yerevanSightTwoText: "A monumental stairway, open-air art space and viewpoint with sweeping city panoramas and, on clear days, Mount Ararat.",
    yerevanSightThreeTitle: "Matenadaran",
    yerevanSightThreeText: "A celebrated research institute and museum preserving thousands of Armenian manuscripts and the country's written heritage.",
    yerevanSightFourTitle: "Vernissage & GUM Market",
    yerevanSightFourText: "Discover handmade crafts, paintings and souvenirs at Vernissage, then taste dried fruits, sweets, spices and local produce at GUM Market.",
    yerevanSightFiveTitle: "Opera & Northern Avenue",
    yerevanSightFiveText: "Enjoy Yerevan's cultural center, elegant pedestrian streets, cafés, boutiques and an energetic evening atmosphere.",
    yerevanSightSixTitle: "Erebuni Museum & Fortress",
    yerevanSightSixText: "Explore the birthplace of Yerevan and see artifacts that reveal the city's Urartian origins.",
    yerevanExperienceTitle: "Experience the city like a local",
    yerevanExperienceText: "Begin with Armenian coffee, walk through leafy parks and sculpture gardens, browse local design shops, discover hidden wine bars and end the evening over a generous Armenian dinner. Yerevan is best appreciated slowly—through conversation, flavor and spontaneous moments.",
    yerevanFoodTitle: "Food, wine and evening life",
    yerevanFoodText: "The capital brings Armenia's regional cuisine together in one place. Try fresh lavash, dolma, grilled meats, vegetable dishes, gata and local wines. From traditional taverns with live music to contemporary restaurants and rooftop terraces, evenings in Yerevan are warm and sociable.",
    yerevanWhenTitle: "When to visit",
    yerevanWhenText: "Spring and autumn offer comfortable weather for walking and outdoor dining. Summer is sunny and lively, while winter brings festive lights, museums, warm cafés and a quieter city atmosphere.",
    yerevanTipTitle: "A local travel tip",
    yerevanTipText: "Leave time beyond the formal sightseeing program. Many of Yerevan's best moments happen between landmarks—in courtyards, cafés, markets, parks and conversations with local people.",
  ...
  hy: {
    ...
    aboutEdgeLabel: "Մեր առավելությունը",
    aboutEdgeText: "Մեր ուժը նպատակակետի կառավարման փորձի և միջազգային գործընկերային ցանցի համադրությունն է։ Այն մեզ հնարավորություն է տալիս յուրաքանչյուր հաճախորդին առաջարկել լավագույն արժեքը, վստահելի կազմակերպում և իսկապես ստեղծագործ լուծումներ։",
    aboutArmeniaTitle: "Ներկայացնում ենք Հայաստանի իրական ոգին",
    aboutArmeniaOne: "Որպես Հայաստանի կայացած ներգնա տուրօպերատորներից մեկը՝ Liberty Incentive-ը շարունակաբար զարգանում է՝ արձագանքելով զբոսաշրջության նոր միտումներին և հաճախորդների փոփոխվող հետաքրքրություններին։",
    aboutArmeniaTwo: "Մենք հպարտությամբ ներկայացնում ենք Հայաստանն աշխարհին՝ իր յուրահատուկ մշակույթով, հնագույն պատմությամբ, կենդանի սովորույթներով, անաղարտ բնությամբ, ինքնատիպ ճարտարապետությամբ և գունեղ արվեստով։",
    aboutArmeniaThree: "Մեր աշխատանքը կենտրոնացած է այն փորձառությունների վրա, որոնք Հայաստանը կարող է պարգևել իր մշակույթի, ավանդույթների և բացառիկ հյուրընկալության միջոցով։ Յուրաքանչյուր ծրագրում հաշվի ենք առնում նաև երկրի աշխարհագրական դիրքը, սոցիալական կայունությունը, կլիման, մասնագիտական զբոսաշրջային ծառայությունները և մրցունակ արժեքը։",
    aboutGoalsTitle: "Մենք սահմանում ենք հստակ նպատակներ",
    aboutGoalOne: "Օգնել ճանապարհորդներին զգալ հայկական ոգին՝ մեր անկրկնելի բնության, մշակութային ժառանգության և յուրահատուկ հյուրընկալության միջոցով։",
    aboutGoalTwo: "Ապահովել լավագույն պայմանները ճանապարհորդության, բացահայտումների և հանգստի համար։",
    aboutGoalThree: "Հասկանալ յուրաքանչյուր պահանջ և դարձնել յուրաքանչյուր հանգիստ հարմարավետ, անխափան և անմոռանալի։",
    aboutToursLabel: "Ինչ ենք մենք ստեղծում",
    aboutToursTitle: "Մեկ ուղղություն։ Այն բացահայտելու անհամար տարբերակներ։",
    aboutToursIntro: "Liberty Incentive-ը ստեղծում է բազմազան ճանապարհորդություններ ամբողջ Հայաստանում, Վրաստանի հետ համակցված ծրագրեր և խնամքով մշակված փորձառություններ աշխարհի տարբեր ուղղություններով։",
    aboutToursCulture: "Դասական, մշակութային, պատմական, ուխտագնացության և կրոնական տուրեր",
    aboutToursMice: "Խրախուսական ուղևորություններ, MICE, համաժողովներ, միջոցառումներ և կորպորատիվ ծրագրեր",
    aboutToursActive: "Քայլարշավներ, հեծանվային, ջիպ, մոտո, էքստրեմալ և արկածային տուրեր",
    aboutToursNature: "Աշխարհագրական, էկո, թռչնադիտարկման, որսորդական, ձկնորսական և ֆոտոտուրեր",
    aboutToursLifestyle: "Գինու, գաստրոնոմիական, շոփինգի, բժշկական, ձմեռային և նավակով տուրեր",
    aboutToursClasses: "Հայկական պարերի, խոհանոցի, արհեստների և ավանդույթների վարպետության դասեր",
    aboutStayTitle: "Կացություն՝ յուրաքանչյուր ճանապարհորդական ոճի համար",
    aboutStayText: "Մենք առաջարկում ենք տարբեր բյուջեների և նախասիրությունների համապատասխան կացության տարբերակներ՝ միջազգային հինգաստղանի և բուտիկ հյուրանոցներից մինչև ընտանեկան հյուրընկալ կացարաններ ու հոսթելներ։",
    aboutTeamTitle: "Բազմալեզու մասնագիտական թիմ",
    aboutTeamText: "Մեր սպասարկման թիմում ընդգրկված են անգլերեն, ֆրանսերեն, գերմաներեն, չինարեն, իտալերեն և իսպաներեն լեզուներին տիրապետող փորձառու զբոսավար-թարգմանիչներ, քայլարշավի և լեռնագնացության մասնագետներ, վարորդներ, խոհարարներ և օգնականներ։ Նրանցից շատերը տարիներ շարունակ աշխատում են մեզ հետ և ընտրվում են ոչ միայն մասնագիտական ու լեզվական հմտությունների, այլև ժամանակակից Հայաստանը խորությամբ ներկայացնելու կարողության համար։",
    aboutOptionsTitle: "Լավագույն տարբերակները յուրաքանչյուր գործընկերոջ համար",
    aboutOptionOne: "Ավանդական և ստեղծագործ գաղափարներ",
    aboutOptionTwo: "Անհատականացված լուծումներ",
    aboutOptionThree: "Գրավիչ ծրագրային ձևավորում",
    aboutOptionFour: "Մրցունակ գնային առաջարկներ",
    aboutOptionFive: "Ճկունություն՝ յուրաքանչյուր փորձառությունը Ձեր կարիքներին համապատասխանեցնելու համար",
    aboutQuote: "Հաջողությունը հիմնված չէ արտասովոր բաներ անելու, այլ սովորական բաները բացառիկ լավ կատարելու վրա։",
    aboutClosingTitle: "Միացեք մեզ և հարստացրեք Ձեր կյանքը նոր փորձառություններով։",
    aboutClosingText: "Liberty Incentive-ը պատրաստ է դիմավորել Ձեզ հայկական առանձնահատուկ ջերմությամբ և հյուրընկալությամբ։",
    ...
    /* Yerevan destination page */
    yerevanPageTitle: "Բացահայտեք Երևանը | Liberty Incentive",
    yerevanHeroLabel: "Վարդագույն քաղաք",
    yerevanHeroTitle: "Երևան",
    yerevanHeroText: "Հնագույն արմատներ, ստեղծագործ էներգիա և ջերմ հյուրընկալություն Հայաստանի սրտում։",
    backToArmenia: "← Վերադառնալ «Բացահայտեք Հայաստանը» բաժին",
    yerevanIntro: "Աշխարհի հնագույն շարունակաբար բնակեցված քաղաքներից մեկը՝ Երևանը միաժամանակ պատմական և ժամանակակից մայրաքաղաք է՝ վարդագույն հրաբխային քարով, բաց հրապարակներով, շատրվաններով, արվեստով և սրճարանային մշակույթով։",
    yerevanStoryTitle: "Հռոմից ավելի հին քաղաք",
    yerevanStoryOne: "Երևանի պատմությունը սկսվում է Էրեբունի ամրոցից, որը մ.թ.ա. 782 թվականին հիմնադրել է Արգիշտի Ա թագավորը։ Հնավայրը մինչ օրս վեր է խոյանում ժամանակակից մայրաքաղաքի վրա՝ միավորելով ուրարտական պատմությունն ու քաղաքի այսօրվա կյանքը։",
    yerevanStoryTwo: "Այսօր Երևանը Հայաստանի մշակութային և հասարակական կենտրոնն է։ Նրա զբոսանքի համար հարմար կենտրոնը միավորում է խորհրդային քաղաքաշինությունը, ժամանակակից ճարտարապետությունը, պատկերասրահները, երաժշտությունը, շուկաներն ու աշխույժ հանրային տարածքները։",
    yerevanFactsFounded: "Հիմնադրվել է",
    yerevanFactsFoundedValue: "մ.թ.ա. 782 թ․",
    yerevanFactsCharacter: "Հայտնի է որպես",
    yerevanFactsCharacterValue: "Վարդագույն քաղաք",
    yerevanSightsTitle: "Անպայման այցելելու վայրեր",
    yerevanSightOneTitle: "Հանրապետության հրապարակ",
    yerevanSightOneText: "Քաղաքի գլխավոր հրապարակը՝ շրջապատված վարդագույն ճարտարապետությամբ, թանգարաններով և երեկոյան երգող շատրվաններով։",
    yerevanSightTwoTitle: "Կասկադ",
    yerevanSightTwoText: "Մոնումենտալ աստիճաններ, բացօթյա արվեստի տարածք և դիտակետ՝ քաղաքի ու պարզ եղանակին Արարատ լեռան համայնապատկերով։",
    yerevanSightThreeTitle: "Մատենադարան",
    yerevanSightThreeText: "Հռչակավոր գիտահետազոտական ինստիտուտ և թանգարան, որտեղ պահպանվում են հազարավոր հայկական ձեռագրեր։",
    yerevanSightFourTitle: "Վերնիսաժ և ԳՈՒՄ շուկա",
    yerevanSightFourText: "Վերնիսաժում բացահայտեք ձեռագործ աշխատանքներ, նկարներ ու հուշանվերներ, իսկ ԳՈՒՄ շուկայում համտեսեք չրեր, քաղցրավենիք, համեմունքներ և տեղական մթերք։",
    yerevanSightFiveTitle: "Օպերա և Հյուսիսային պողոտա",
    yerevanSightFiveText: "Վայելեք քաղաքի մշակութային կենտրոնը, հետիոտնային փողոցները, սրճարանները, խանութներն ու աշխույժ երեկոյան մթնոլորտը։",
    yerevanSightSixTitle: "Էրեբունի թանգարան և ամրոց",
    yerevanSightSixText: "Բացահայտեք Երևանի ծննդավայրը և ուրարտական ծագումը ներկայացնող արժեքավոր գտածոները։",
    yerevanExperienceTitle: "Զգացեք քաղաքը տեղացու պես",
    yerevanExperienceText: "Օրը սկսեք հայկական սուրճով, զբոսնեք կանաչ այգիներով ու քանդակների պուրակներով, այցելեք տեղական դիզայնի խանութներ ու գինու բարեր, իսկ երեկոն ավարտեք հայկական առատ ընթրիքով։ Երևանը լավագույնս բացահայտվում է դանդաղ՝ զրույցների, համերի և անսպասելի պահերի միջոցով։",
    yerevanFoodTitle: "Խոհանոց, գինի և երեկոյան կյանք",
    yerevanFoodText: "Մայրաքաղաքը մեկ վայրում միավորում է Հայաստանի տարբեր շրջանների խոհանոցը։ Համտեսեք թարմ լավաշ, տոլմա, խորոված, բանջարեղենային ուտեստներ, գաթա և տեղական գինիներ։ Ավանդական երաժշտությամբ պանդոկներից մինչև ժամանակակից ռեստորաններ ու տանիքային տեռասներ՝ Երևանի երեկոները ջերմ և մարդամոտ են։",
    yerevanWhenTitle: "Երբ այցելել",
    yerevanWhenText: "Գարունն ու աշունը հարմար են զբոսանքի և բացօթյա ընթրիքի համար։ Ամառը արևոտ ու աշխույժ է, իսկ ձմեռը քաղաքը լցնում է տոնական լույսերով, թանգարաններով, ջերմ սրճարաններով և ավելի հանգիստ մթնոլորտով։",
    yerevanTipTitle: "Տեղացու խորհուրդ",
    yerevanTipText: "Ժամանակ թողեք նաև պաշտոնական ծրագրից դուրս։ Երևանի լավագույն պահերից շատերը ծնվում են տեսարժան վայրերի միջև՝ բակերում, սրճարաններում, շուկաներում, այգիներում և տեղացիների հետ զրույցներում։",
